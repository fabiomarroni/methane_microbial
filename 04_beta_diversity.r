#Perform clustering and heatmap like my work on mozzarella, but now using ComplexHeatmap to improve readability

do.cluster<-function(infile="basepath/tables/16s_merged_count_by_Family.txt",
                    metafile="basepath/tables/metadata.csv",
					pdffile="basepath/plots/Family_new_heatmap.pdf",
...
#Change names for some classes which had incomplete names
